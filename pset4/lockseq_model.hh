...
public:
    ...
    void print_latency_samples(std::ostream& out) const;

private:
    enum class latency_phase {
        lock = 0,
        write = 1,
        clear = 2,
        unlock = 3,
    ...
    static constexpr size_t latency_phase_count = 4;
    ...
    std::array<std::vector<std::chrono::nanoseconds>, latency_phase_count>
        latency_samples_;

    void record_latency(latency_phase phase, cotamer::steady_time_point start);
